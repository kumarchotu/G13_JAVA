...
public class EditDoctors extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditDoctors frame = new EditDoctors();
	 ...
	 */
	public EditDoctors() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(EditDoctors.class.getResource("/Assects/Suretrust.png")));
		...
		JLabel lblNewLabel = new JLabel("EDIT DOCTOR DETAILS");
		lblNewLabel.setForeground(new Color(255, 255, 255));
		lblNewLabel.setFont(new Font("Tempus Sans ITC", Font.BOLD, 37));
		lblNewLabel.setBounds(190, 10, 409, 49);
		...
		btnNewButton.setBounds(295, 297, 184, 38);
		...
		btnNewButton_1.setBounds(76, 294, 168, 45);
		...
		btnNewButton_2.setBounds(525, 297, 151, 38);
